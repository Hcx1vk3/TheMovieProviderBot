...
BOT_TOKEN = environ.get('BOT_TOKEN', "7142847336:AAHYFb2J4JbCdoeRkwyOR53tvCgMCwXa0is")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6053231890 6981181936').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002075335780') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002041998086') # support group id ( make sure bot is admin )
...
HOWTOVERIFY = environ.get('HOWTOVERIFY', url='https://t.me/How_to_Download_7x/26') # How to open tutorial link for verification
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002035209060')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/RagnarDiscussion') #Support group link ( make sure bot is admin )
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001982900399')).split()]
